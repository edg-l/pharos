...
use pharos_types::{BeaconSpec, MinimalBeaconSpec, PayloadStatus};
...
/// Alias to the shared constant in `crate::common::checkpoint_helpers`.
...
///
/// Delegates to `crate::common::checkpoint_helpers::build_anchor_bellatrix` and wraps
...
async fn engine_pipeline_drives_bellatrix_chain() {
    ...
    // so t = 10_000_000 yields ~1.6M slots for MinimalBeaconSpec (SLOT_DURATION_MS = 6_000).
    fc.time = 10_000_000;
