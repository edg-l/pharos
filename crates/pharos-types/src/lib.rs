...
//! phase0::balances                 | Gwei=u64           | VALIDATOR_REGISTRY_LIMIT | Naive    | per-epoch         | multi-per-chunk packed u64
//! phase0::slashings                | Gwei=u64           | EPOCHS_PER_SLASHINGS_VECTOR| Naive  | rarely            | multi-per-chunk packed u64
...
//! altair::balances                 | Gwei=u64           | VALIDATOR_REGISTRY_LIMIT | Naive    | per-epoch         | multi-per-chunk packed u64
//! altair::inactivity_scores        | u64                | VALIDATOR_REGISTRY_LIMIT | Naive    | per-epoch         | multi-per-chunk packed u64
//! altair::previous_epoch_particip. | ParticipationFlags=u8| VALIDATOR_REGISTRY_LIMIT| Naive   | per-epoch flush   | multi-per-chunk packed u8
//! altair::current_epoch_particip.  | ParticipationFlags=u8| VALIDATOR_REGISTRY_LIMIT| Naive   | per-block         | multi-per-chunk packed u8
...
//! bellatrix::balances              | Gwei=u64           | VALIDATOR_REGISTRY_LIMIT | Naive    | per-epoch         | multi-per-chunk packed u64
//! bellatrix::inactivity_scores     | u64                | VALIDATOR_REGISTRY_LIMIT | Naive    | per-epoch         | multi-per-chunk packed u64
//! bellatrix::previous_epoch_part.  | ParticipationFlags=u8| VALIDATOR_REGISTRY_LIMIT| Naive   | per-epoch flush   | multi-per-chunk packed u8
//! bellatrix::current_epoch_part.   | ParticipationFlags=u8| VALIDATOR_REGISTRY_LIMIT| Naive   | per-block         | multi-per-chunk packed u8
//! ```
//!
